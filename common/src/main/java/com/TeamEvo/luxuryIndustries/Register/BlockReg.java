...
public class BlockReg {
    ...
    public static final RegistrySupplier<Block> TYPEWRITER = BLOCKS.register("typewriter", () -> new TypeWriter(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BLACK).pushReaction(PushReaction.IGNORE).explosionResistance(10f).strength(10.0F, 10F).noOcclusion()));
